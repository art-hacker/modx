...
$_lang["plugin_management_msg"] = $_lang["snippet_management_msg"] = $_lang["tmplvars_management_msg"] = $_lang["htmlsnippet_management_msg"] = $_lang["template_management_msg"] = "";
$_lang["manager_lockout_message"] = 'В данный момент вы находитесь в режиме привилегированного пользования сайтом. Чтобы закончить сеанс, нажмите кнопку \'Выйти\'. <p />Чтобы перейти на главную или стартовую страницу, нажмите кнопку \'Домой\'.';
