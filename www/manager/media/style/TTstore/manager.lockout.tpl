...
<form method="post" name="loginfrm" id="loginfrm" action="processors/login.processor.php">
    <!-- the logo -->
    <div class="sectionHeader" style='background:#80766c; padding: 18px;'>
        <!--img src='media/style/[+theme+]/images/misc/login-logo.png' alt='[+logo_slogan+]' /-->
        <img src='../assets/templates/default/images/logo.png' alt='[+logo_slogan+]' />
    </div>
    <!-- end #mx_logobox -->
    ...
    <div class="sectionBody">
        ...
        <div class="loginMessage" style='font-size:12px'>[+manager_lockout_message+]</div>
        <fieldset class="buttonset">
          <input type="button" class="login" id="submitButton" value="Заказы" onclick="top.location = '../assets/modules/orders/'"  />
